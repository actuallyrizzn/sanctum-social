...
class FeedArgs(BaseModel):
    feed_name: Optional[str] = Field(None, description="Named feed preset. Available feeds: 'home' (timeline), 'discover' (what's hot), 'ai-for-grownups', 'atmosphere', 'agent-cafe'. If not provided, returns home timeline")
...
def get_bluesky_feed(feed_name: str = None, max_posts: int = 25) -> str:
    ...
    Args:
        feed_name: Named feed preset - available options: 'home', 'discover', 'ai-for-grownups', 'atmosphere', 'agent-cafe'
    ...
    try:
        ...
        feed_presets = {
            ...
            "agent-cafe": "at://did:plc:gfrmhdmjvxn2sjedzboeudef/app.bsky.feed.generator/agent-cafe"
        }
