...
from platforms.bluesky.orchestrator import save_notification_to_queue, notification_to_dict
...
def recover_notifications(hours=24, dry_run=True):
    ...
    # Initialize database with context manager for proper cleanup
    with NotificationDB() as db:
